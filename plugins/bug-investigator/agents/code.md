...
description: |
  ...
  assistant: "I'll launch the code agent to search the relevant repos."
  </example>

  <example>
  Context: Bug investigator orchestrator is launching Team 3.
  orchestrator: "Launch code. Bug: members see incorrect benefit limits after clicking 'Start session'. Affected app: Member Portal. Bug first reported: 2026-03-10."
  </example>
model: opus
color: blue
---
