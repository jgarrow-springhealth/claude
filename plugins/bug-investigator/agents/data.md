...
description: |
  ...
  assistant: "I'll launch the data agent to query Snowflake, Datadog, and Mixpanel for this bug."
  </example>

  <example>
  Context: Bug investigator orchestrator is launching Team 1.
  orchestrator: "Launch data. Bug: providers with care_navigation_specialty_care role cannot be updated. Known identifiers: user UUID abc-123, timestamp 2026-03-15T18:00Z. Affected app: Compass."
  </example>
model: opus
color: cyan
---
